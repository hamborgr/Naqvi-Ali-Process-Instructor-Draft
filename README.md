---
# Applying to Become a Machine Learning Engineer
By Ali Naqvi

## Table of Contents

- [Learning How to Network with Professionals](#learning-how-to-network-with-professionals)
    - [Networking with ML Engineers](#networking-with-ml-engineers)
    - [Networking with Recruiters](#networking-with-recruiters)
    - [Networking with Professors](#networking-with-professors)
    - [Networking with Peers](#networking-with-peers)
...
Recruiters for ML Engineering will likely be found at career fairs so its best to sign up for those as much as possible. When meeting these recruiters it will be mostly similar to when you're talking to an engineer, where you're focused on what the day-to-day work is like and how you can best prepare for the position. 
...
Although your peers may not be able to help you directly land a job, it's just as important to make good connections with your classmates or others in this field.

Whether it be classmates or anyone else you might run into who's near this position in your career, it's crucial to find common ground with them, as well as help each other find opportunities. By creating a relationship with others, you'll be able to expand to new opportunities that you might not have had the chance to come across.  

---

## Tailoring a Resume
A good resume is a given when applying for any kind of sought after position. Here are some best practices for maximizing the potential of your resume through adjusting how to describe your experiences and formatting your document.

### Describing your Experiences
Your resume will always have jobs or experiences that relate to the company you are applying to, however your resume most likely only contains what you did at that job. Recruiters don't want to know what exactly you did during your time elsewhere. 

Identify and discuss what kind of tangible impact you made. This could be statistics, such as the project you worked on whose internet traffic went up due to your enhancements or marketing. This could also be qualitative impacts like improving brand reputation.

### Formatting your Resume
All resumes contain personal information, jobs/experiences, skills, and most will have an objective. 
